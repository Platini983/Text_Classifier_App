...
# Training Data
data = [( "my unity test failed","Software"),
("tried the program, but it was bukky","Software"),
...
# Model Building
model = compose.Pipeline(('vectorize',fx.BagOfWords(lowercase=True)),('nv',naive_bayes.MultinomialNB()))
for x,y in data:
